	                 ...
	                 <div class="span12">
						<div class="widget-box">
							<div class="widget-title">
							    ...
							    <h5>用户表</h5>
								<div class="buttons"><s:a action="user_addUI" cssClass="btn btn-mini"><i class="icon-plus"></i>添加</s:a></div>
							</div>
							<div class="widget-content nopadding">
								<table class="table table-bordered table-striped">
									...
									<td>${email}</td>
									<td>
										&nbsp;&nbsp;&nbsp;&nbsp;<s:a action="user_show?id=%{id }" cssClass="btn btn-info btn-mini">查看用户信息</s:a>&nbsp;&nbsp;&nbsp;&nbsp;<s:a action="user_editUI?id=%{id}" cssClass="btn btn-primary btn-mini">修改</s:a>&nbsp;&nbsp;&nbsp;&nbsp;<s:a action="user_delete?id=%{id}" cssClass="btn btn-danger btn-mini delete" >删除</s:a>&nbsp;&nbsp;&nbsp;&nbsp;<s:a href="user_initPassword.action?id=%{id}" cssClass="btn btn-success btn-mini init-password">初始化密码</s:a>
									</td>
									</tr>
									</s:iterator>
