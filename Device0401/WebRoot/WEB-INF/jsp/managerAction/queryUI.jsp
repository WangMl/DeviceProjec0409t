					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<s:form cssClass="form-horizontal" method="post" action="manager_addUI" name="basic_validate" id="basic_validate" novalidate="novalidate" >
                                    ...
                                    <div class="form-actions">
                                        <input type="submit" value="查询上级领导，请点击" class="btn btn-primary" />
                                    </div>
                                </s:form>    
