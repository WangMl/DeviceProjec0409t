					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<s:form cssClass="form-horizontal" method="post" action="topic_add" name="basic_validate" id="basic_validate" novalidate="novalidate" >
                                   <s:hidden name="forumId"></s:hidden>
                                    <div class="control-group">
                                        <label class="control-label">名称</label>
                                        <div class="controls">
                                            <s:textfield type="text" name="title" id="title" />
                                        </div>
                                    </div>
                                    <div class="control-group">
