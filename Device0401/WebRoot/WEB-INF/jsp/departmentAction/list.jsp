	                 ...
	                 <div class="span12">
						<div class="widget-box">
							<div class="widget-title">
							    ...
							    <h5>部门表</h5>								 
								<div class="buttons"><s:a action="department_addUI" cssClass="btn btn-mini"><i class="icon-plus"></i>添加</s:a></div>
							</div>
							<div class="widget-content nopadding">
								<table class="table table-bordered table-striped">
									...
									<td>${description}&nbsp;</td>
									<td>
										&nbsp;&nbsp;&nbsp;&nbsp;<s:a action="department_editUI?id=%{id}" cssClass="btn btn-primary btn-mini">修改</s:a>&nbsp;&nbsp;&nbsp;&nbsp;<s:a action="department_delete?id=%{id}" cssClass="btn btn-danger btn-mini delete">删除</s:a>
									</td>
									</tr>
									</s:iterator>
									</tbody>
